...
class ProjectsPageLocators():
    ...
    NEW_CREATE_BTN = (By.CSS_SELECTOR, "button[data-loading='false'] span[class='one-ui-button__content']")
    ARCHIVE_MENU_BTN = (By.CSS_SELECTOR, "body > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > button:nth-child(5)")
    DOTS_BTN = (By.CSS_SELECTOR, "button[data-size='sm'] span[class='one-ui-button__content']")
    ARCHIVE_BTN = (By.CSS_SELECTOR, "body > div:nth-child(19) > div.one-ui-popout__menu.one-ui-view > div > div > div > div > div > div > button:nth-child(5)")
    DELETE_BTN = (By.CSS_SELECTOR, "div[class='one-ui-popout__menu one-ui-view'] div:nth-child(1) div:nth-child(1) div:nth-child(1) button:nth-child(2) span:nth-child(1)")
    ARCHIVE_POPUP_BTN = (By.CSS_SELECTOR, "button[data-type='alert'] span[class='one-ui-button__content']")
    DELETE_POPUP_BTN = (By.CSS_SELECTOR, "button[data-type='alert'] span[class='one-ui-button__content']")
